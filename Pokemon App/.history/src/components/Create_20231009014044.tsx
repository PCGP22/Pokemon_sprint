              ...
              <div>
                <fieldset className="stats__inputs">
                  ...
                  <div className="slider__container">
                    ...
                    <Slider state={hp} key="attSlide" maxWidth={300} />
                  </div>
                  <div className="slider__container">
                    <label htmlFor="defense">Defense</label>{" "}
                    <Slider state={hp} key="defSlide" maxWidth={300} />
                  </div>
                  <div className="slider__container">
                    <label htmlFor="sp-att">Sp-att</label>{" "}
                    <Slider state={hp} key="spaSlide" maxWidth={300} />
                  </div>
                  <div className="slider__container">
                    <label htmlFor="sp-def">Sp-def</label>{" "}
                    <Slider state={hp} key="spdSlide" maxWidth={300} />
                  </div>
                  <div className="slider__container">
                    <label htmlFor="speed">Speed</label>{" "}
                    <Slider state={hp} key="speedSlide" maxWidth={300} />
                  </div>
                </fieldset>
