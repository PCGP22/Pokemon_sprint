      ...
      <main className=".create">
        <form>
          <fieldset className="create__top">
            ...
            <fieldset>
              <h2>Base stats:</h2>
              <label htmlFor="hp">HP</label> <Slider maxWidth={400} />
              <br />
              <label htmlFor="attack">Attack</label> <Slider maxWidth={400} />
              <br />
              <label htmlFor="defense">Defense</label> <Slider maxWidth={400} />
              <br />
              <label htmlFor="sp-att">Sp-att</label> <Slider maxWidth={400} />
              <br />
              <label htmlFor="sp-def">Sp-def</label> <Slider maxWidth={400} />
              <br />
              <label htmlFor="speed">Speed</label> <Slider maxWidth={400} />
              <br />
            </fieldset>
            <fieldset>
