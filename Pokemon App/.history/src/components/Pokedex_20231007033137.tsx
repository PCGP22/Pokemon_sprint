  ...
  return (
    <>
      ...
      <main className="pokedex__main">
        <path d="m528.17,125.19l-95.75,75.48c-9.44,7.44-21.49,11.53-33.95,11.53H63.06c-33.45,0-60.56-24.8-60.56-55.39V57.89C2.5,27.3,29.61,2.5,63.06,2.5h685.64c33.45,0,60.56,24.8,60.56,55.39v28.36c0,11.65-10.33,21.1-23.07,21.1h-205.52c-19.27,0-37.91,6.33-52.51,17.84Z" />
