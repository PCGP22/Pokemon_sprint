              ...
              <div>
                <fieldset className="stats__inputs">
                  ...
                  <div className="slider__container">
                    ...
                    <Slider state={hp} key="hpSlide" maxWidth={300} />
                  </div>
                  <div className="slider__container">
                    <label htmlFor="attack">Attack</label>{" "}
                    <Slider state={stats.att} key="attSlide" maxWidth={300} />
                  </div>
                  <div className="slider__container">
                    <label htmlFor="defense">Defense</label>{" "}
                    <Slider state={stats.def} key="defSlide" maxWidth={300} />
                  </div>
                  <div className="slider__container">
                    <label htmlFor="sp-att">Sp-att</label>{" "}
                    <Slider state={stats.sp_att} maxWidth={300} />
                  </div>
                  <div className="slider__container">
                    <label htmlFor="sp-def">Sp-def</label>{" "}
                    <Slider state={stats.sp_def} maxWidth={300} />
                  </div>
                  <div className="slider__container">
                    <label htmlFor="speed">Speed</label>{" "}
                    <Slider state={stats.speed} maxWidth={300} />
                  </div>
                </fieldset>
