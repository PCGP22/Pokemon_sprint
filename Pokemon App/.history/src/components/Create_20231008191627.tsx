          ...
          <fieldset className="create__top">
            ...
            <div>
              <fieldset className="stats__inputs">
                ...
                <div className="slider__container">
                  <label htmlFor="attack">Att</label> <Slider maxWidth={300} />
                </div>
                <div className="slider__container">
                  <label htmlFor="defense">Def</label> <Slider maxWidth={300} />
                </div>
                <div className="slider__container">
              ...
              <fieldset>
                <button type="reset" tabIndex={2} className="create__buttons">
                  Reset form
                </button>
                <button type="button" tabIndex={2} className="create__buttons">
                  Create Pokémon
                </button>
              </fieldset>
            </div>
