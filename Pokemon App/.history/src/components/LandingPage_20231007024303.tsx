        ...
        <section className="landing__features__section">
          ...
          <figure className="landing__features">
            <section className="landing__features__container">
              ...
              <a href="/pokedex" className="z-indexed">
                <img
                  src={pokedexPreview}
                  alt="pokédex preview"
          ...
          <figure className="landing__features">
            <section className="landing__features__container">
              ...
              <a href="/homePage">
                <figure className="flippo_container">
        ...
        <section className="landing__features__section">
          ...
          <figure className="landing__features">
            <section className="landing__features__container">
              ...
              <a href="/create_pokemon" className="z-indexed">
                <img
                  src={createPreview}
