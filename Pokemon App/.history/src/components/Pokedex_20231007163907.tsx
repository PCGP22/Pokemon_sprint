        ...
        <section className="pokedex__stats">
          <div>
            <svg
              ...
              data-name="Capa 2"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 835.85 174.78">
              <defs>
                <clipPath id="clippath">
                  <rect className="cls-3" width="835.85" height="174.78" />
                </clipPath>
              </defs>
              <g id="Capa_1-2" data-name="Capa 1">
                <g className="cls-2">
                  <path
                    className="cls-12"
                    d="m815.09,156.39v497.74c0,32.28-25.73,58.44-57.46,58.44H8.33V198.08c-.41-7.78-.26-18.19,0-32.13v-7.61l.14-.02c.44-23.52.94-55.84-.14-100.25C7.48,23.42,28.02,2.68,52.31,2.68h243.59c9.05,0,17.8,4.09,24.66,11.53l69.54,75.48c10.6,11.51,24.14,17.84,38.14,17.84,0,0,149.26,0,149.26,0,.82.01,1.58.09,2.32.19l190.78-.19c24.57,0,44.5,21.87,44.5,48.85Z"
                  />
                </g>
              </g>
            </svg>
