      ...
      <main>
        <form>
          ...
          <fieldset>
            ...
            <br />
            <textarea name="description" id="description" tabIndex={3} />
            <br />
            <fieldset>
              <p>Type(s)</p>
              <input type="checkbox" value="bug" tabIndex={4} />{" "}
              <span>Bug</span> <br />
              <input type="checkbox" value="dark" tabIndex={5} />{" "}
              <span>Dark</span> <br />
              <input type="checkbox" value="dragon" tabIndex={6} />{" "}
              <span>Dragon</span> <br />
              <input type="checkbox" value="electric" tabIndex={7} />{" "}
              <span>Electric</span>
              <br />
              <input type="checkbox" value="fighting" tabIndex={8} />{" "}
              <span>Fighting</span>
              <br />
              <input type="checkbox" value="fire" tabIndex={9} />{" "}
              <span>Fire</span> <br />
